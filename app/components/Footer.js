...
export default function Footer() {
  return (
    ...
    <footer aria-label="Site Footer" class="bg-bestiolegreen">
      <div
      ...
      >
        ...
        >
          <div>
            <Image src="/LogoBestiole.png" height={300} width={500}></Image>
          </div>
          <div>
            ...
            <nav aria-label="Footer Navigation - Legal" class="mt-6">
              <ul class="space-y-4 text-sm">
                <li>
                  <h1 class="text-gray-700 font-bold transition hover:opacity-75">
                    Bestiole
                  </h1>
                </li>

                <li>
                  <h2 class="text-gray-700 transition hover:opacity-75">
                    bestiole@wanadoo.fr
                  </h2>
                </li>
          ...
          <div>
            ...
            <nav aria-label="Footer Navigation - Legal" class="mt-6">
              <ul class="space-y-4 text-sm">
                ...
                <li>
                  <a href="/presentation" class="text-gray-700 transition hover:opacity-75">
                    Qui sommes-nous ?
                  </a>
                </li>

                <li>
                  <a href="/objectifs" class="text-gray-700 transition hover:opacity-75">
                    Nos objectifs
                  </a>
                </li>
        ...
        <p class="text-xs text-gray-500">
          &copy; 2023. Bestiole. All rights reserved.
        </p>
      </div>
    </footer>
